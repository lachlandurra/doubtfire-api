...
ActiveRecord::Schema[7.1].define(version: 2025_10_05_200630) do
  ...
  create_table "magic_link_requests", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["email", "sent_at"], name: "index_magic_link_requests_on_email_and_sent_at"
    t.index ["email"], name: "index_magic_link_requests_on_email"
    t.index ["expires_at"], name: "index_magic_link_requests_on_expires_at"
    t.index ["request_ip", "sent_at"], name: "index_magic_link_requests_on_request_ip_and_sent_at"
    t.index ["token_digest"], name: "index_magic_link_requests_on_token_digest", unique: true
    t.index ["user_id"], name: "index_magic_link_requests_on_user_id"
  ...
  create_table "users", charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    ...
    t.datetime "personal_email_verified_at"
  ...
  add_foreign_key "magic_link_requests", "users"
