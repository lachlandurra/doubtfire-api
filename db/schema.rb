...
ActiveRecord::Schema[7.1].define(version: 2026_04_11_000001) do
  ...
  create_table "user_linked_logins", charset: "utf8mb4", collation: "utf8mb4_uca1400_ai_ci", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.string "provider", null: false
    t.string "provider_identifier", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["provider", "provider_identifier"], name: "index_user_linked_logins_on_provider_and_provider_identifier", unique: true
    t.index ["user_id"], name: "index_user_linked_logins_on_user_id"
  end
  ...
  add_foreign_key "user_linked_logins", "users"
